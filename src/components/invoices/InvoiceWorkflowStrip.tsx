import { INVOICE_STEPS, stepIndex, type InvoiceStage } from "@/lib/invoiceWorkflow";
import { Check, ChevronRight, AlertTriangle } from "lucide-react";
import { cn } from "@/lib/utils";

/**
 * Visual 7-step strip for invoice reconciliation. Mirrors the call-off
 * WorkflowStrip so the two modules feel like one product.
 */
export function InvoiceWorkflowStrip({
  stage,
  flagged,
  compact = false,
}: {
