...
function ProjectLayout() {
  ...
  const capChecks: Record<Capability, boolean> = {
    ...
    "upload.drawings": useCan("upload.drawings"),
    "approve.drawings": useCan("approve.drawings"),
    "lock.tender": useCan("lock.tender"),
    "unlock.tender": useCan("unlock.tender"),
    "withdraw.drawings.own": useCan("withdraw.drawings.own"),
    "bulk.upload.drawings": useCan("bulk.upload.drawings"),
    "export.drawings.register": useCan("export.drawings.register"),
